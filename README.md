...
<img src="./assets/script-container.svg" alt="can't-load-scripts" />
...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link" href="#">Dev environment</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="#">Frameworks</a>
    </li>
    <li class="nav-item">
        <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">to be added</a>
    </li>
</ul>
